  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <span class="ms-auto d-flex">
        <a
          class="btn btn-light px-3 me-2 py-2"
          href="https://github.com/seriousm4x/UpSnap/releases/tag/3.0.0"
        >
          <i class="me-2 fa-solid fa-angles-up" />UpSnap v3 available!
        </a>
        <DarkToggle />
        <div class="dropdown">
          <button
        ...
        <div class="btn btn-light px-3 me-2 py-2 pe-none">
          <i
            class="me-2 fa-solid {visitors === 1 ? 'fa-user' : 'fa-user-group'}"
          />{visitors}
      ...
      <div class="modal-body">
        ...
        >
          <div class="row">
            <div class="col-sm">
              <div class="mb-3">
                <label for="inputNameAddDevice" class="form-label"
                  >Device name</label
                >
                <input
                  type="text"
            ...
            <div class="col-sm">
              <div class="mb-3">
                <label for="inputMacAddDevice" class="form-label"
                  >Mac address</label
                >
                <input
                  type="text"
          ...
          <div class="row">
            ...
            <div class="col-sm">
              <div class="mb-3">
                <label for="inputNetmaskAddDevice" class="form-label"
                  >Netmask</label
                >
                <input
                  type="text"
          ...
          <div class="row">
            <div class="col-auto ms-auto">
              <button
                type="submit"
                form="addForm"
                class="btn btn-outline-success">Add device</button
              >
            </div>
          </div>
          ...
          {#if !settings.discovery}
            <div class="callout callout-danger mb-2">
              <p class="m-0">
                To enable this option, please enter your network address in the
                settings.
              </p>
            </div>
          {/if}
      ...
      <div class="modal-body">
        <form id="settingsForm" on:submit|preventDefault={updateSettings}>
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="mb-3">
                <label for="inputIntervalSettings" class="form-label"
        ...
        <div class="callout callout-info mb-2">
          <p class="m-0">
            Backup file structure has changed in v2. You can still restore both
            versions with this file upload.
          </p>
        </div>
        <div class="mb-3">
